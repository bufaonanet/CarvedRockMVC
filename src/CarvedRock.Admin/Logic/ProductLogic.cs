...
public class ProductLogic : IProductLogic
{
    ...
    public async Task<ProductModel> InitializedProductModel()
    {
    ...
    public async Task<ProductModel> GetAvailableCategories(ProductModel productModel)
    {
